...
Diferencia máxima **Pórtico ↔ OpenSees: 4.2e-9** (relativa). Los dos motores resuelven el mismo modelo con la misma formulación, así que lo que ambos comparten frente a la referencia analítica es discretización, no error de Pórtico.
