...
import { Viewport }        from './ui/viewport.js?v=5';
import { PropertiesPanel } from './ui/properties.js?v=5';
import { MenuBar }         from './ui/menu.js?v=5';
import { renderMarkdown }  from './ui/markdown.js?v=5';
import { UndoStack }       from './utils/undo.js?v=5';
import { esc }             from './utils/escape.js?v=5';
import { StaticSolver, ensureDefaultLC }   from './solver/static_solver.js?v=5';
import { Results }                         from './solver/postprocess.js?v=5';
import { assessStabilitySanity, STABILITY } from './solver/stability.js?v=5';
import { areaStress, areaBendingStress, vonMises, areaLocalFrame } from './solver/membrane.js?v=5';
import { ModalSolver, guyanReduce }        from './solver/modal_solver.js?v=5';
import { buildNodeIndex, assembleK, assembleF, getNodeDOFs } from './solver/assembler.js?v=5';
import { assembleSparseGlobal, extractFreeCSR } from './solver/sparse.js?v=5';
import { solveCorotBeam } from './solver/corotbeam.js?v=5';
import { insertInfill } from './model/macromodel.js?v=5';
import { listMacros, getMacro, insertMacro } from './model/macro_registry.js?v=5';
import { assembleKg } from './solver/geometric.js?v=5';
import { makeFactor } from './solver/linsolve.js?v=5';
import { ModalResults }                    from './solver/modal_results.js?v=5';
import { parseAccelerogram, accStats, scaleToPGA, DEMO_PRESETS, G as GACC } from './solver/accelerograms.js?v=5';
import { tendonEquivalentLoads, applyTendon, tendonEcc } from './solver/tendon.js?v=5';
import { computeMovingLoad } from './solver/moving_load.js?v=5';
import { buildShearStories, runShearHistory, shearFreqs } from './solver/shear_building.js?v=5';
import { solvePlastic } from './solver/plastic.js?v=5';
import { linearBuckling, pDelta } from './solver/geometric_analysis.js?v=5';
import { buildNLTrussProblem, buildCorotProblem, remapCorotSteps, buildFormFindProblem, setupPushoverControl } from './solver/nl_frame.js?v=5';
import { driftLimit } from './design/serviceability.js?v=5';
import { buildSpectrum } from './design/nch433_spectrum.js?v=5';
import { selectProfile, steelCandidates, predimensionar, candidatesForFamily } from './design/autodesign.js?v=5';
import { jointSCWB } from './design/seismic.js?v=5';
import { resolveMaterial } from './design/material_props.js?v=5';
import { resolveSectionProps } from './design/section_props.js?v=5';
import { autoDetectDiaphragms, computeFloorCR } from './solver/diaphragm.js?v=5';
import { interstoryDrifts, buildStoryLevels } from './solver/drift.js?v=5';
import { splitElement, splitByLength, discretizeAll, joinElements, intersectElements } from './model/discretize.js?v=5';
import { localAxes, stiffnessMatrix, massMatrix, transformMatrix, globalStiffness, applyReleases } from './solver/timoshenko.js?v=5';
import { blockCells, cornerGridIndices } from './model/mesher.js?v=5';
import { coonsGridFromCorners } from './model/mesh_map.js?v=5';
import { meshPolygonIntoModel } from './model/mesh_free.js?v=5';
import { smoothAreasInModel } from './model/mesh_quality.js?v=5';
import { listFormats, exportModel, importModel } from './io/index.js?v=5';
import { extensions } from './ext/extensions.js?v=5';
import { loadBranding, getBranding } from './branding.js?v=5';
import { SpectrumSolver }    from './solver/spectrum_solver.js?v=5';
import { modalTimeHistory }  from './solver/timehistory.js?v=5';
...
import { reportHTML, reportDocx, reportDocxCover, reportDocxBody } from './report/report.js?v=5';
...
class App {
  ...
  _staticWorkerSolve(K, nDOF, freeDOF, Flist, dense = false) {
    return new Promise((resolve, reject) => {
      let worker;
      try { worker = new Worker(new URL('./solver/static_worker.js?v=5', import.meta.url), { type: 'module' }); }
  ...
  async runModal(opts = {}) {
    ...
    try {
      ...
      let modes = await new Promise((resolve, reject) => {
        const worker = new Worker(new URL('./solver/modal_worker.js?v=5', import.meta.url), { type: 'module' });
  ...
  async runTimeHistory(opts = {}) {
    ...
    try {
      ...
      const rawModes = await new Promise((resolve, reject) => {
        const w = new Worker(new URL('./solver/modal_worker.js?v=5', import.meta.url), { type: 'module' });
  ...
  _thSolveInWorker(modes, ag, dt, zeta) {
    return new Promise((resolve, reject) => {
      let w;
      try { w = new Worker(new URL('./solver/timehistory_worker.js?v=5', import.meta.url), { type: 'module' }); }
      catch (e) {
...
4,100</textarea></div>
  ...
  async predimensionarDialog() {
    ...
    if (document.getElementById('pd-assign').checked) {
      const { profileToSection } = await import('./design/profiles.js?v=5');
      this.snapshot();
  ...
  _solveNLInWorker(kind, opts) {
    return new Promise((resolve, reject) => {
      let worker;
      try {
        worker = new Worker(new URL('./solver/nl_worker.js?v=5', import.meta.url), { type: 'module' });
      } catch (e) {
...
<details style="margin-top:12px">
  ...
  async applyModelOperations(ops, ctx = null) {
    ...
    this.snapshot();
    const { applyOperations } = await import('./model/model_ops.js?v=5');
  ...
  async _generateFromSpec(specText) {
    ...
    try {
      ...
      const { generateModel } = await import('../assistant/generator.js?v=5');
    ...
    inp.onchange = async () => {
      ...
      try {
        mods = await Promise.all([
          import('./io/ifc/ifcToPortico.js?v=5'),
          import('./ui/ifcImportDialog.js?v=5'),
          import('./io/neutral.js?v=5'),
        ]);
  ...
  async exportIFC() {
    ...
    try {
      const [{ modelToNeutral }, { neutralToIFC }] = await Promise.all([
        import('./io/neutral.js?v=5'),
        import('./io/ifc/ifcWriter.js?v=5'),
      ]);
      const m = this._predisc ? this.serializer.fromJSON(this._predisc) : this.model;
  ...
  async generateReportDocx() {
    ...
    try {
      const { Docx } = await import('./io/docx.js?v=5');
      let d;
      if (multi) {
