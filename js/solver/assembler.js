...
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=4';
import { applyLinkConstraints } from './links.js?v=4';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs, areaSelfWeightContribs } from './membrane.js?v=4';
