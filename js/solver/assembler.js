...
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=1';
import { applyLinkConstraints } from './links.js?v=1';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=1';
